...
<body>
<form name="joinP" action="join.do" method="post">
<table border=1>
	<h1>Naver</h1>
	<tr>
		<td>아이디</td>
		<td>
			<input type="text" name="id" id="id" placeholder="아아디" size="30" 
			 onfocus="idCheck()"
	...
	<tr>
		<td>이름</td>
		<td>
			<input type="text" name="name" id="name" placeholder="홍길동" size="30" maxlength="10"
			onfocus="nameCheck()"
